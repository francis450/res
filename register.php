...
if (isset($_POST['q']) && isset($_POST['iq'])) {
	$init = $_POST['q'];
	$cc = $_POST['iq'];
	$gh = mysqli_query($con, "update peddingorders set status = '$init'+1 where ordernumber='$cc'");
	if ($gh) {
...
if (isset($_POST['r']) && isset($_POST['ir'])) {
	$init = $_POST['r'];
	$cc = $_POST['ir'];
	$gh = mysqli_query($con, "update peddingorders set status = '$init'+1 where ordernumber='$cc'");
	if ($gh) {
...
if (isset($_POST['s']) && isset($_POST['is'])) {
	$init = $_POST['s'];
	$cc = $_POST['is'];
	$gh = mysqli_query($con, "update peddingorders set status = '$init'+1 where ordernumber='$cc'");
	if ($gh) {
